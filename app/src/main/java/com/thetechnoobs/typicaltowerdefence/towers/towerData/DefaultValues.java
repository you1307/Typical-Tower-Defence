...
public class DefaultValues {
    ...
    public static final int cannonRange = 3;
    public static final int cannonDamage = 3;
    public static final int cannonPrice = 100;
    public static final float cannonFireRate = 2.0f;


    public static final int wizardRange = 5;
    ...
    public static final int troopsRange = 10;
